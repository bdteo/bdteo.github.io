...
[conversational tone] In meinen Notizen lag ein winziges TODO:
...
[reflective] Die besten Ergebnisse, die ich mit modernen KI-Modellen bekomme, kommen nicht aus "Prompt Engineering" im alten Internetsinn.
...
[deadpan] Die Ausgabe sah gut aus. Das war der gefährliche Teil: ordentliche Abschnitte, sorgfältige Einschränkungen, "act as..."-Rahmen, Erfolgskriterien, professionelle Formulierungen. Sehr 2023.
...
[reflective] Ich hatte ein modernes Modell gebeten, Prompts zu verbessern, und es gab mir ein Genre-Artefakt aus einer älteren Modellära.
...
[calm] Aber die Modelle haben sich verändert.
...
Auch die offizielle Anleitung hat sich leise in diese Richtung bewegt. OpenAIs Prompting-Grundlagen sagen, dass es keinen einzelnen perfekten Prompt gibt, und vergleichen Prompting mit einem Gespräch mit einem Kollegen. Ihre Guidance für Reasoning-Modelle sagt, man solle Prompts einfach und klar halten. Anthropics Einführung ins Prompt-Design sagt, Claude versteht umgangssprachliches Englisch, hat aber deinen Kontext nicht, wenn du ihn nicht gibst.

Auch die Forschung hat vor Sprödigkeit gewarnt. Ask Me Anything beschreibt Prompting als spröde; The Butterfly Effect of Altering Prompts fand, dass winzige Änderungen in der Formulierung Modellentscheidungen verändern können.
...
[deliberate] Hör auf, das Modell raten zu lassen, welche Teile deiner Situation wichtig sind.
...
[reflective] was immer wieder schiefläuft.
...
[calm] Struktur ist immer noch wichtig. Wiederholbarkeit ist immer noch wichtig.
...
[reflective] Modelle lernen aus der Welt, die wir ihnen hinterlassen.
...
[slows down] Prompt Engineering wurde populär, weil die Modelle noch nicht gut genug waren, damit sich normale Sprache zuverlässig anfühlte.
