...
[matter-of-fact] I built a thing that pulls data from a source, cleans it up, and shows it better than the original. Standard work.

Then I queried the second-largest entry in the system. Everything else returned hundreds of results.

[deadpan] This one: zero.
...
[reflective] That is when I started digging.
...
[emphasized] You were not missing an endpoint. The endpoint was missing reality.

[reflective] I asked a question nobody thought to ask: where did this data live before the internet?
...
[wistfully] My competitors have been doing this manually for thirty years.

I wrote a scraper in an afternoon. Partly curiosity, partly spite.

[tired] The document parsing is where things get properly painful.
...
[resigned tone] Each bug takes longer to find than to fix. That is always the ratio with text extraction: ninety percent detective work, ten percent code.
...
[awe] It actually works.

[reflective] Parsing shows you what is there. Then I start looking for what is not.
...
[deadpan] In twenty twenty six.

[reflective] The source is not a database. It is a window, and someone keeps closing it.

The first data source shaped the architecture. The second one broke every assumption.

[wistfully] I needed a second architecture. Which is a polite way of saying the first one was not really an architecture. It was just a working solution that happened to fit one case.
...
[reflective] The architecture is better because I waited. If I had built it on day one, I would have designed for the only source I knew.

The second one, the weird one, forced me to find what actually matters.

[emphasized] You cannot design for the unknown. But you can refactor when it arrives.

The architecture taught me how to build. The market taught me what to build for.

[matter-of-fact] I am entering a market with an incumbent that has run for thirty years. Their tech looks like two thousand five. Their moat is not technology. It is trust, brand recognition, and decades of accumulated data.
...
[wistfully] Turns out cheaper does not automatically mean better positioned.
...
[deliberate] I price high. I can always come down.

[reflective] Four lessons, condensed.

[deliberate] First: authoritative does not mean complete. The primary source was missing an entire segment. The data existed, just not where anyone expected.
...
[emphasized] Third: data is not permanent. If you need it, save it. The source will not.

Fourth: price for what you are becoming, not what you are. The subscription is a door. Build what is behind it.

[quietly] The interesting work lives in the gaps.

[softly] That is where I live too.
