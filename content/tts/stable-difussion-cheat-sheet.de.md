...
[matter-of-fact] Welches Modell du verwenden solltest.

[conversational tone] Das ist inzwischen die erste Entscheidung, und sie ist wichtiger als jede Parameter-Feinjustierung.

Modell, Am besten für, Auflösung, Hinweise.

Flux 2; Fotorealismus, Prompt-Treue; 1024x1024+; Bestes Open-Weight-Modell für Fotorealismus im Jahr 2026. In Adobe Photoshop integriert.

SDXL; Allgemeine Nutzung; 1024x1024; Riesiges Ökosystem an Fine-Tunes. Juggernaut XL, Realistic Vision, DreamShaper.

SD 3.5 Large; Höchste Qualität (Stabilitys Flaggschiff); 1024x1024; MMDiT-Architektur. SD 3.0 wurde im April 2025 eingestellt.

SDXL Lightning; Geschwindigkeit; 1024x1024; Generierung in 2-8 Schritten. Bessere Qualität als Turbo bei höherer Auflösung.
...
[deliberate] UI, Am besten für.

ComfyUI; Power-User. Node-basiert, besseres VRAM-Management, 15 Prozent schneller, beste Flux-Unterstützung. Seit 2025 der Branchenstandard für ernsthafte Arbeit.
...
[conversational tone] Die Sampler-Debatte ist weitgehend entschieden.

Meine Standardwahl:

DPM++ 2M Karras -- bestes Verhältnis aus Geschwindigkeit und Qualität. Das ist mein Default für fast alles.

[matter-of-fact] DPM++ SDE Karras -- bei niedrigen Schrittzahlen etwas besser. Gut, wenn du schnell iterierst.
...
[slows down] 1-4; Sehr kreativ, lockere Interpretation. Oft inkohärent.
...
[matter-of-fact] Hinweis: SD 3.5 nutzt einen anderen Guidance-Mechanismus. Das CFG-Konzept gilt weiterhin, aber die Skala verhält sich anders -- fang niedriger an (3-5) und justiere dann nach.
...
[deliberate] Über die native Auflösung hinauszugehen riskiert Artefakte und Kompositionsprobleme. Nutze Hi-Res Fix oder Upscaling, statt direkt mit 2048x2048 zu generieren.
...
[matter-of-fact] "bad anatomy" ist zu vage, um nützlich zu sein. "ugly" funktioniert nicht, weil SD nicht mit als "ugly" gelabelten Bildern trainiert wurde.

Manche Modelle schneiden mit langen Negatives nachweislich schlechter ab.
...
[deliberate] Halt es kurz -- maximal 5-10 Begriffe.
...
[matter-of-fact] 8GB-Karten; 8GB; Minimal brauchbar. ComfyUI hilft beim VRAM-Management.
...
[deliberate] Kein VRAM mehr; Zu ComfyUI wechseln, Batch-Größe reduzieren, fp16 verwenden.
