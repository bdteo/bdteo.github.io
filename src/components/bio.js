        ...
        {author?.name && (
          <>
            ...
            <p className="bio-intro">
              I write about software development, AI experiments, and the
              occasional deep dive into computer science topics that catch my
              interest.
            </p>
            <p className="bio-summary" itemProp="description">
              {author.summary}
            </p>
