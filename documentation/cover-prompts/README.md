...
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [why-i-built-hammergebot](why-i-built-hammergebot.prompt.txt) (+ [inline](why-i-built-hammergebot.inline-house-in-the-stack.prompt.txt))                | large willow basket heaped with brown eggs under one warm lamp                    | Pentax 67 105 mm f/2.4 Takumar, Cinestill 800T                         |
| [what-if-human-connection-were-public-infrastructure](what-if-human-connection-were-public-infrastructure.prompt.txt)                                   | two cups, biscuits, and a folded scarf waiting on a public bench                  | Leica M6 35 mm Summicron, Portra 400                                   |
| [ai-video-is-a-routing-problem-now](ai-video-is-a-routing-problem-now.prompt.txt)                                                                       | hand rerouting a cloth cable across an unlabeled analog patch board               | Leica M6 35 mm Summicron, Fuji Pro 400H                                |
| [how-to-prompt-without-prompting](how-to-prompt-without-prompting.prompt.txt)                                                                           | translucent vellum layers aligning over a blank page                              | Hasselblad 500C/M 80 mm Zeiss Planar, Portra 400                       |
| [xen-goo-for-kubernetes-nodes](xen-goo-for-kubernetes-nodes.prompt.txt)                                                                                 | marked token accepted into a green-lit tray compartment among unmarked discs      | Mamiya 7II 80 mm f/4, Fuji Pro 400H                                    |
| [how-things-break](how-things-break.prompt.txt)                                                                                                         | brass door handle held by a small hanging key, cool light waiting under the door  | Leica M6 35 mm Summicron, Portra 400                                   |
...
| [m1-mac-android-emulator-bluetooth-passthrough-bumble](m1-mac-android-emulator-bluetooth-passthrough-bumble.prompt.txt)                                 | two modern phones face-down on marble, faint cyan halo crossing the gap           | Mamiya 7II 80 mm f/4, Fuji Pro 400H _(modern subject on analog film)_  |
...
| [installing-php-8-3-6-with-imap-on-macos-using-phpenv](installing-php-8-3-6-with-imap-on-macos-using-phpenv.prompt.txt)                                 | phone on marble with a pale cyan notification halo + folded letter + fountain pen | Mamiya 7II 80 mm f/4, Fuji Pro 400H _(modern subject on analog film)_  |
| [laravel-sail-vs-laradock-choosing-right-docker-solution](laravel-sail-vs-laradock-choosing-right-docker-solution.prompt.txt)                           | two modern wireless mice side by side on white marble                             | Leica M6 35 mm Summicron, Portra 400 _(modern subject on analog film)_ |
...
| [google-ai-ambitions-historical-analysis-promises-stock-market-impact](google-ai-ambitions-historical-analysis-promises-stock-market-impact.prompt.txt) | open notebook on oak with a subtle hand-drawn pencil line chart, pen, tea         | Mamiya 7II 80 mm f/4, Portra 400 _(modern minimalist)_                 |
